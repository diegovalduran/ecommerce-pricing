...
import { Database, DollarSign, Package, Store, Percent, Tag, TrendingUp } from "lucide-react"
...
export function DatabaseOverview({ stats, isLoading, productsCount }: DatabaseOverviewProps) {
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{stats.uniqueStores}</div>
          <p className="text-xs text-muted-foreground">
            Active data sources
          </p>
        </CardContent>

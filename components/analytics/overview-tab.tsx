    ...
    <>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7 mt-4">
        <Card className="col-span-4">
          <CardHeader>
            <CardTitle className="text-xl font-semibold">Product Engagement</CardTitle>
          </CardHeader>
        ...
        <Card className="col-span-3">
          <CardHeader>
            <CardTitle className="text-xl font-semibold">System Activity</CardTitle>
          </CardHeader>
          <CardContent>
            <UserActivity />
          </CardContent>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7 mt-4">
        <Card className="col-span-4">
          <CardHeader>
            <CardTitle className="text-xl font-semibold">Product Collection Growth</CardTitle>
          </CardHeader>
          <CardContent>
